//! 2048 game move logic and precomputed move tables.
//! 
//! This module contains the core game mechanics for the 2048 puzzle game,
//! including precomputed move tables for efficient move calculation.
...
impl Moves {
    ...
    /// Load precomputed moves from generated data
    /// This would be used in production to load the precomputed tables
    pub fn from_precomputed() -> Moves {
        // In a real implementation, this would load from the generated moves_data.rs
        // For now, we'll use the computed version
        Self::new()
    }
}
