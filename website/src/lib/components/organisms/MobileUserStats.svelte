...
<button type="button" on:click={() => drawerStore.open(drawerSettings)} class="flex items-center justify-end p-2 bg-[#FAF8EF] rounded-lg shadow-md">
    <div class="bg-[#ed8d33] flex items-center px-4 py-2 rounded-md space-x-4">
        <!-- Rank -->
